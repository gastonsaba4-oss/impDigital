...
function PlatformPage() {
  ...
  async function onCreateSite(site) {
    const { branding, logoSize, ...registryFields } = site;
    ...
    const commonWrites = [
      ...
      saveShared(siteKey(full.id, "config"), { ...DEFAULT_SITE_CONFIG, logoSize: logoSize || "md" }),
  ...
  async function onUpdateSite(site) {
    ...
    saveShared(siteKey(site.id, "config"), { ...DEFAULT_SITE_CONFIG, ...currentConfig, logoSize: logoSize || "md" });
